...
void *sendToWorker(void *arg) {
    ...
    worker_client.call("sendQuery", serialized_gal_key, serialized_query[0]);
    ...
    worker_client.call("sendQuery", serialized_gal_key, serialized_query[(my_id%NUM_WORKER_PER_GROUP)/SPLIT_FACTOR]);
