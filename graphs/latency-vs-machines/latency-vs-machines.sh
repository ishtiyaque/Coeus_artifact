...
set style line 3 lc rgb '#006a4e' dt 1 lt 1 lw 8 pt 9 pi -1 ps 2.5
...
plot \
'latency-vs-machines.dat' using 1:(\$2/1000000) with linespoints ls 4 title 'Base. (small)',\
'latency-vs-machines.dat' using 1:(\$3/1000000) with linespoints ls 5 title 'Base. (medium)',\
'latency-vs-machines.dat' using 1:(\$4/1000000) with linespoints ls 6 title 'Base. (large)',\
'latency-vs-machines.dat' using 1:(\$5/1000000) with linespoints ls 1 title 'Coeus (small)',\
'latency-vs-machines.dat' using 1:(\$6/1000000) with linespoints ls 2 title 'Coeus (medium)',\
'latency-vs-machines.dat' using 1:(\$7/1000000) with linespoints ls 3 title 'Coeus (large)',\
" > plot.plt
gnuplot plot.plt
epspdf $EPS
rm $EPS
